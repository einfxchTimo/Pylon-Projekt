...
public class BluetoothUtil {
    ...
    static class Device implements Comparable<Device> {
        ...
        @Override
        public int compareTo(Device other) {  //Sortiert Geräte nach Namen
    ...
    /**
     * Android 12 Berechtigung handlen
     */
